...
params:
    rmd: "hunt_report.Rmd"
    maternal: snakemake@input[[1]][1]
    paternal: snakemake@input[[1]][2]
    fetal: snakemake@input[[1]][3]
    confounding: snakemake@input[[2]]
    hom12: snakemake@input[[3]]
    hom24: snakemake@input[[4]]
    rotthom: snakemake@input[[5]]
...
if (grepl('harvest', params$confounding)){

moms= read.table('/mnt/work/pol/ROH/harvest/pheno/runs_mfr_maternal.txt', h=T, sep= '\t')
dads= read.table('/mnt/work/pol/ROH/harvest/pheno/runs_mfr_paternal.txt', h=T, sep= '\t')
fets= read.table('/mnt/work/pol/ROH/harvest/pheno/runs_mfr_fetal.txt', h=T, sep= '\t')
...
m= fread('/mnt/work/pol/ROH/harvest/runs/harvestm12_maternal.hom')
m24= fread('/mnt/work/pol/ROH/harvest/runs/harvestm24_maternal.hom')

m= rbind(m, m24)
ms= m %>% group_by(CHR) %>% summarize(n= n(), KB= median(KB, na.rm=T))

d= fread('/mnt/work/pol/ROH/harvest/runs/harvestm12_paternal.hom')
d24= fread('/mnt/work/pol/ROH/harvest/runs/harvestm24_paternal.hom')

d= rbind(d, d24)
ds= d %>% group_by(CHR) %>% summarize(n= n(), KB= median(KB, na.rm=T))

fe= fread('/mnt/work/pol/ROH/harvest/runs/harvestm12_fetal.hom')
fe24= fread('/mnt/work/pol/ROH/harvest/runs/harvestm24_fetal.hom')
...
freqm= read.table('/mnt/work/pol/ROH/harvest/runs/frequency/ROH_frequency_maternal', h=F, sep= '\t')
names(freqm)= c('chr','pos','freqm')

freqf= read.table('/mnt/work/pol/ROH/harvest/runs/frequency/ROH_frequency_fetal', h=F, sep= '\t')
names(freqf)= c('chr','pos','freqf')

flist= list.files('/mnt/work/pol/ROH/harvest/results/maps_cox/maternal/')
res_m= lapply(paste0('/mnt/work/pol/ROH/harvest/results/maps_cox/maternal/', flist), read.table)
res_m= do.call("rbind", res_m)
res_m= data.frame(res_m)

flist= list.files('/mnt/work/pol/ROH/harvest/results/maps_cox/fetal/')
res_f= lapply(paste0('/mnt/work/pol/ROH/harvest/results/maps_cox/fetal/', flist), read.table)
...
if (grepl('rott',params$confounding )){

moms= read.table('/mnt/work/pol/ROH/rotterdam1/pheno/runs_mfr_maternal.txt', h=T, sep= '\t')
dads= read.table('/mnt/work/pol/ROH/rotterdam1/pheno/runs_mfr_paternal.txt', h=T, sep= '\t')
fets= read.table('/mnt/work/pol/ROH/rotterdam1/pheno/runs_mfr_fetal.txt', h=T, sep= '\t')
q1= read.table(params$confounding, h=T, sep= ';')
...
m= fread('/mnt/work/pol/ROH/rotterdam1/runs/rotterdam1_maternal.hom')

ms= m %>% group_by(CHR) %>% summarize(n= n(), KB= median(KB, na.rm=T))

d= fread('/mnt/work/pol/ROH/rotterdam1/runs/rotterdam1_paternal.hom')

ds= d %>% group_by(CHR) %>% summarize(n= n(), KB= median(KB, na.rm=T))

fe= fread('/mnt/work/pol/ROH/rotterdam1/runs/rotterdam1_fetal.hom')
...
freqm= read.table('/mnt/work/pol/ROH/rotterdam1/runs/frequency/ROH_frequency_maternal', h=F, sep= '\t')
names(freqm)= c('chr','pos','freqm')

freqf= read.table('/mnt/work/pol/ROH/rotterdam1/runs/frequency/ROH_frequency_fetal', h=F, sep= '\t')
names(freqf)= c('chr','pos','freqf')

freq= inner_join(freqm, freqf, by= c('chr','pos'))

flist_m= list.files('/mnt/work/pol/ROH/rotterdam1/results/maps_cox/maternal/')
res_m= lapply(paste0('/mnt/work/pol/ROH/rotterdam1/results/maps_cox/maternal/', flist_m), read.table)
res_m= do.call("rbind", res_m)
res_m= data.frame(res_m)

flist_f= list.files('/mnt/work/pol/ROH/rotterdam1/results/maps_cox/fetal/')
res_f= lapply(paste0('/mnt/work/pol/ROH/rotterdam1/results/maps_cox/fetal/', flist_f), read.table)
res_f= do.call("rbind", res_f)
res_f= data.frame(res_f)
