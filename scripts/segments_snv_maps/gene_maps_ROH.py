...
g= g.loc[g.chr== int(snakemake.wildcards.CHR), :]
...
for infile in input_files:
	...
	temp_df= temp_chr.loc[temp_chr.CHR== int(snakemake.wildcards.CHR), :]
...
temp_chr= chr_df.loc[chr_df.CHR== int(snakemake.wildcards.CHR), :]
